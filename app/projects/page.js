...
useGSAP(() => {
  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-b mt-20 from-black via-gray-900 to-black text-white font-sans overflow-hidden px-4 sm:px-6 md:px-10 lg:px-20 py-16 sm:py-20 will-change-transform">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-center mb-12 sm:mb-20">
        <span className="text-[14vw] sm:text-[10vw] md:text-[8vw] font-[font2] bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent leading-none">
          Projects
        </span>
